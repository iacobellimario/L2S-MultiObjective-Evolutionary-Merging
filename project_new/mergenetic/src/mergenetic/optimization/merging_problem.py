...
class BaseMergingProblem(ABC, Problem):
    ...
    def load_model(
        ...
        # ----> Se use_lm_eval e backend qwen, restituisci solo il path come stringa
        if self.use_lm_eval and hasattr(self, "eval_backend") and getattr(self, "eval_backend", None) == "qwen":
            return str(path)
