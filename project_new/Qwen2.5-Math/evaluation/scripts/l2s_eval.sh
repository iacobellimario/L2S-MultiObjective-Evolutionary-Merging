...
#SBATCH --output=logs/baseline/deepseek-r1-7B.out
#SBATCH --gres=gpu:1
...
MODEL_PATH="/leonardo_scratch/fast/IscrC_LENS/miacobel/model/DeepSeek-R1-Distill-Qwen-7B"
OUTPUT_DIR="outputs/baseline/DeepSeek-R1-Distill-Qwen-7B"
SEED=0
SPLIT="test"
NUM_TEST_SAMPLE=-1
